...
func main() {
	...
	appAuthV1.Use(routes.AdminAuthMiddleWare())
	{
		...
		appAuthV1.POST("/password/set", admin.UpdateAdminPassword)
		appAuthV1.GET("/html/dashboard", admin.TmplDashboard)
		...
		appAuthV1.GET("/html/admin/record_login", admin.TmplRecordAdminLogin)
		appAuthV1.GET("/html/member/user_bank", admin.TmplUserBank)
		appAuthV1.GET("/html/member/manual_deposit", admin.TmplManualDeposit)
		appAuthV1.GET("/html/member/manual_withdraw", admin.TmplManualWithDraw)
		...
		appAuthV1.GET("/html/notice/roll_notice", admin.TmplRollNotice)
		appAuthV1.GET("/html/notice/normal_notice", admin.TmplNormalNotice)
		...
		appAuthV1.GET("/pages/admin/record_login", admin.PageFindRecordAdminLogin)
		...
		appAuthV1.GET("/pages/notice/list", admin.PageFindNoticeList)
		appAuthV1.GET("/notice/detail", admin.GetNotice)
		appAuthV1.POST("/notice/update", admin.SetNotice)
		appAuthV1.POST("/notice/add", admin.AddNotice)
		...
		appAuthV1.POST("/money/manual_deposit", admin.ManualDeposit)
		appAuthV1.POST("/money/manual_withdraw", admin.ManualWithdraw)
